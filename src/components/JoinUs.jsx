...
const joinCopy = {
  ja: {
    ...
    teamAction: '募集状況を見る',
    audienceDescription: '対象は早稲田大学高等学院の生徒及びその保護者です。参加申込みは2学期開始時点に受付を始める予定です。',
  ...
  en: {
    ...
    audienceDescription: 'Audience registration is open to students of Waseda University Senior High School and their parents or guardians. Registration is scheduled to begin at the start of the second school term.',
